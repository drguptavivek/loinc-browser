...
Agent-facing LOINC KB docs live in `docs/agent/`. `LOINC_CONCEPTS.md` is the lightweight index; focused docs include `LOINC_TERM_STRUCTURE.md`, `LOINC_NAMES_AND_DISPLAY.md`, `LOINC_SPECIAL_CASES.md`, `LOINC_DATABASE_STRUCTURE.md`, `LOINC_PART_LINKAGES.md`, `LOINC_MAPPING_GUIDANCE.md`, and `LOINC_LICENSE_NOTE.md`. Keep source-derived KB sections linked to the original LOINC or related source page.
