...
- `docs/agent/LOINC_CLCI.md`: Common Lab Codes for India (NRCeS): how the optional CLCI file becomes a ranking prior, the `clci` filter, and `clciName`; why "Blood" also matches serum or plasma.
